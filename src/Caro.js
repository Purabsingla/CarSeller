...
export function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 ">
      ...
      >
        ...
        <p className="flex items-center font-extrabold">Home</p>
      </Typography>
      <Typography
        as="li"
        variant="small"
  ...
  return (
    <Navbar className=" sticky top-0 z-10 mx-auto max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4 bg-white blur-none">
